...
public class GetErrorCodes
{
    ...
    public GetErrorCodes(IV1StopCosmosDbService<Common.Models.v2.Stop> stopCosmosDbService)
    {
    ...
    public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "get", Route = "v2/GetErrorCodes")] HttpRequest req, ILogger log)
    {
