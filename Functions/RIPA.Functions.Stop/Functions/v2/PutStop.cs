...
public class PutStop
{
    ...
    public PutStop(IV1StopCosmosDbService<Common.Models.v2.Stop> stopCosmosDbService,
    ...
    [FunctionName("PutStop_v2")]
    [OpenApiOperation(operationId: "v2/PutStop", tags: new[] { "name", "v2" })]
    ...
    public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "put", Route = "v2/PutStop/{Id}")] Common.Models.v2.Stop stop, HttpRequest req, string Id, ILogger log)
    {
