...
public class PostMarkPiiFlag
{
    ...
    public PostMarkPiiFlag(IStopCosmosDbService<Common.Models.v2.Stop> stopCosmosDbService,
        IUserProfileCosmosDbService<Common.Models.v2.UserProfile> userProfileCosmosDbService,
    ...
    [FunctionName("PostMarkPiiFlag_v2")]
    [OpenApiOperation(operationId: "v2/PostMarkPiiFlag", tags: new[] { "name", "v2" })]
    ...
    [OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(Common.Models.v2.Stop), Description = "Stop Updated")]
    ...
    public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = "v2/PostMarkPiiFlag/{Id}")] HttpRequest req, string Id, ILogger log)
    {
