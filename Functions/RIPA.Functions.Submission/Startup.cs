...
namespace RIPA.Functions.Submission
{
    public class Startup : FunctionsStartup
    {
...
#endif
            Microsoft.Azure.Cosmos.CosmosClient client = new Microsoft.Azure.Cosmos.CosmosClient(account, key, clientOptions);
        ...
        private static async Task<StopCosmosDbService> InitializeStopCosmosClientInstanceAsync()
        {
            ...
            clientOptions.ConnectionMode = ConnectionMode.Gateway;
#endif
            clientOptions.RequestTimeout = TimeSpan.FromMinutes(2);
            clientOptions.ApplicationName = "RIPA.Functions.Submission";
            Microsoft.Azure.Cosmos.CosmosClient client = new Microsoft.Azure.Cosmos.CosmosClient(account, key, clientOptions);
