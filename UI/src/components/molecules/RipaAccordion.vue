    ...
    >
      ...
      <v-expansion-panel-content>
        ...
        <div class="stopAccordionWrapper--detailSection">
          ...
          <v-row>
            <v-col cols="5"> Street </v-col>
            <v-col cols="3">
              {{ item.location.streetName }}
            </v-col>
          </v-row>
          <v-row>
            <v-col cols="5"> City </v-col>
            <v-col cols="3">
              {{ item.location.streetname }}
            </v-col>
          </v-row>
          <v-row>
            <v-col cols="5"> Beat </v-col>
            <v-col cols="3">
              {{ item.location.streetname }}
            </v-col>
          </v-row>
        ...
        >
          ...
          >
            <v-row align="center">
              <v-col cols="5"> PERSON {{ i + 1 }} </v-col>
              <v-col cols="3">
                <v-btn color="secondary"> Edit</v-btn>
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="5">Perceived Race</v-col>
              <v-col cols="3">
                <span
                  class="listItems"
            ...
            <v-row>
              <v-col cols="5">Perceived Age</v-col>
              <v-col cols="3">
                {{ person.perceivedAge }}
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="5">Perceived Gender</v-col>
              <v-col cols="3">
                {{ person.perceivedGender }}
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="5">Gender Nonconforming</v-col>
              <v-col cols="3">
                {{ person.genderNonconforming ? 'Yes' : 'No' }}
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="5">Perceived LGBT</v-col>
              <v-col cols="3">
                {{ person.perceivedLgbt ? 'Yes' : 'No' }}
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="5">Perceived Disability</v-col>
              <v-col cols="3">
                <span
                  class="listItems"
                  v-for="(
            ...
            <v-row>
              <v-col cols="5">Reason for Stop</v-col>
              <v-col cols="3">
                <span
                  class="listItems"
            ...
            <v-row>
              <v-col cols="5">Comments on Stop</v-col>
              <v-col cols="3">
                {{ person.reasonForStopExplanation }}
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="5">Actions Taken</v-col>
              <v-col cols="3">
                <span
                  class="listItems"
                  v-for="(
            ...
            <v-row>
              <v-col cols="5">Contraband Discovered</v-col>
              <v-col cols="3">
                <span
                  class="listItems"
                  v-for="(
            ...
            <v-row>
              <v-col cols="5">Result of Stop</v-col>
              <v-col cols="3">
                <span
                  class="listItems"
